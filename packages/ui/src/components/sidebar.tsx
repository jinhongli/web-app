      ...
      <Dialog.Root open={openMobile} onOpenChange={setOpenMobile}>
        <Dialog.Portal>
          ...
          <Dialog.Popup
            ...
            className={cn(
              "fixed inset-y-0 z-50 flex h-full w-(--sidebar-width) flex-col bg-sidebar text-sidebar-foreground outline-none transition-transform duration-200 ease-linear",
              side === "left"
...
function SidebarMenuButton({
  ...
  return (
    <Tooltip.Root disabled={state !== "collapsed" || isMobile}>
      ...
      <Tooltip.Portal>
        <Tooltip.Positioner side="right" align="center" sideOffset={6}>
          <Tooltip.Popup className="z-50 rounded-md border border-border bg-popover px-2 py-1 text-xs text-popover-foreground shadow-md">
            {tooltip}
          </Tooltip.Popup>
        </Tooltip.Positioner>
      </Tooltip.Portal>
...
function SidebarMenuCollapsibleTrigger(
  props: React.ComponentProps<typeof Collapsible.Trigger>
) {
  return (
    <Collapsible.Trigger data-slot="sidebar-menu-collapsible-trigger" {...props} />
  )
}

function SidebarMenuCollapsiblePanel(
  props: React.ComponentProps<typeof Collapsible.Panel>
) {
  return (
    <Collapsible.Panel data-slot="sidebar-menu-collapsible-panel" {...props} />
  )
}
